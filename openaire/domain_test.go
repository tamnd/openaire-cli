...
// HTTP behaviour is covered in openaire_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "openaire://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("openaire", "about")
	if err != nil || got.String() != "openaire://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want openaire://page/about", got.String(), err)
	}
}
