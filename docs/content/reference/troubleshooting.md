...
Most of these come down to network reality or how openaire serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openaire rate-limits like any public site. openaire already paces
...
Where a surface is gated, openaire reads a cookie or token you supply
...
`openaire`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openaire actually did
